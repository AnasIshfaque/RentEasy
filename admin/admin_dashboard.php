...
<div class="dashboardof_Admin">
    <div class="rentalDetails" >
        ...
        <div class="first_car">
            <img src="../assets/images/car_images/Honda_CR-V.png" id="latest_Car_img" alt="Honda CR-V" width="45%" height="90%">
        ...
        <?php 
            $sql1="SELECT Date(pickup_time) as pick_date, Time(pickup_time) as pick_time, Date(dst_time) as desti_date, Time(dst_time) as desti_time FROM renting INNER JOIN vehicle on vehicle.ID=renting.v_id ORDER BY dst_time DESC LIMIT 1";
    ...
    <div class="transaction_pieChart">
        ...
        <div class="recent_transaction">
            <table class="table caption-top">
                ...
                <tbody>
                <?php
                    $sql="SELECT vehicle.model,vehicle.number, vehicle.v_type, Date(dst_time) as date, Time(dst_time) as time FROM renting INNER JOIN vehicle on vehicle.ID=renting.v_id ORDER BY dst_time DESC LIMIT 5";
                    $result1=mysqli_query($conn,$sql);
                    while ($info = mysqli_fetch_array($result1)){
                ?>
                    <tr>
                        <th class="Recent_Transaction_th" style="padding: 0px;"><img src="../assets/images/car_images/Honda_CR-V.png" alt="Honda CR-V" height="80px" width="100px"></th>
